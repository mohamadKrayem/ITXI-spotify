function Album({name, artist, image, date, tracks}) {
return (
    <div className="flex flex-col border-2 border-gray-500 justify-start items-start w-6/6 sm2:w-56">
      ...
      <div className="flex flex-col gap-y-3 h-full justify-between">
        ...
        <div className="mb-0">
            ...
            <input type="button" value="Perview on Spotify" className="sm2:w-[220px] border-t-2 border-gray-500 py-1 cursor-pointer text-base" />
        </div>
      </div>
    </div>
  );
